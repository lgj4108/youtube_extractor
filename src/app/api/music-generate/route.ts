...
export async function POST(request: Request) {
    try {
        ...
        - 섹션 표시는 [Intro], [Verse 1], [Pre-Chorus], [Chorus], [Hook], [Bridge], [Break], [Instrumental], [Outro]처럼 Suno가 해석하기 쉬운 표준 영어 대괄호 태그를 사용해.
        - (whispered), (spoken), (belting), (humming)처럼 실제로 필요한 보컬·퍼포먼스 지시만 영어 소괄호로 표시해. 악기 목록, 줄거리, 카메라 지시, 장면 묘사는 가사 태그에 넣지 마.
